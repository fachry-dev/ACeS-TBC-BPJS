...
<body class="bg-brand-gray">
    ...
    <div class="flex h-screen bg-gray-100">
        <!-- Sidebar Navigasi Dashboard Dokter -->
            ...
            <nav class="mt-6">
                <a href="{{ route('doctor.dashboard') }}" 
                   class="flex items-center px-6 py-3 text-gray-700
                    ...
                    <span class="ml-3">Dashboard Antrian</span>
                </a>

                {{-- 
                  ===============================================================
                  LINK BARU: Konsultasi AI
                  ===============================================================
                --}}
                <a href="{{ route('doctor.konsultasi.baru') }}" 
                   class="flex items-center px-6 py-3 text-gray-700
                          {{ request()->routeIs('doctor.konsultasi.baru') ? 'bg-brand-green-light border-l-4 border-brand-green text-brand-green-dark font-semibold' : 'hover:bg-gray-100' }}">
                    <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z" />
                    </svg>
                    <span class="ml-3">Konsultasi AI Baru</span>
                </a>
