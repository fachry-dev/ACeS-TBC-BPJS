    ...
    <div class="flex h-screen bg-gray-100">
        ...
        <div class="w-64 bg-white shadow-lg">
            ...
            <nav class="mt-6">
                ...
                <a href="{{ route('doctor.konsultasi_baru') }}" 
                   class="flex items-center px-6 py-3 text-gray-700
                          {{ request()->routeIs('doctor.konsultasi_baru') ? 'bg-brand-green-light border-l-4 border-brand-green text-brand-green-dark font-semibold' : 'hover:bg-gray-100' }}">
